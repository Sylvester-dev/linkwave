            ...
            <DialogContent className='bg-white text-black p-0 overflow-hidden'>
                <DialogHeader className='pt-8 px-6'>
                    ...
                    <DialogDescription className='text-center text-zinc-500'>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima dicta non beatae illum suscipit deserunt consequuntur accusamus culpa! Blanditiis, esse in deserunt ut illum id nostrum debitis omnis? Ut, corrupti.
                    </DialogDescription>
                </DialogHeader>
                <Form {...form}>
